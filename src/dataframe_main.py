...
#------------------------------------------------------------
# Download Hashed_Q_Submissions_Raw_Combined.csv and Hashed_allAuthorStatus.csv from https://figshare.com/articles/dataset/Datasets_for_QAnon_on_Reddit_research_project_/19251581
submission_file = '../data/Hashed_Q_Submissions_Raw_Combined.csv'
user_file =  '../data/Hashed_allAuthorStatus.csv' 

output_file = '../data/PostsOfQAnon.csv' # Do not change
#------------------------------------------------------------
